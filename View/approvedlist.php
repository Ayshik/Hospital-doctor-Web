...
require_once ('../Controller/patienttest.php');
$info=approvelist();
?>
                  ...
                  foreach($info as $infos)
                  {
                    echo "<tr>";
                      ...
                      echo "<td>".$infos["phone"]."</td>";
					   ...
					   echo '<td><button class="btn"><a href="addmedicine.php?id='.$infos["sl"].'&amp name='.$infos["patientname"].'&amp phone='.$infos["phone"].'" i class="fa fa-plus">  Add Medicine</a></td>';
